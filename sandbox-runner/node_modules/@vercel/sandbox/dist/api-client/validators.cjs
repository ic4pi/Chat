...
const NetworkPolicyTransformValidator = zod.z.object({ headers: zod.z.record(zod.z.string(), zod.z.string()).optional() });
...
const V2NetworkPolicyObjectValidator = zod.z.object({
	allow: zod.z.union([zod.z.array(zod.z.string()), zod.z.record(zod.z.string(), zod.z.array(NetworkPolicyRuleValidator))]).optional(),
...
const InteractiveSessionResponse = zod.z.object({
	url: zod.z.string(),
	token: zod.z.string()
});
...
exports.InteractiveSessionResponse = InteractiveSessionResponse;
