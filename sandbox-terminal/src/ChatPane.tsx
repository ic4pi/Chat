...
function buildSystemPrompt(
  ...
  parts.push(
    ...
    '- You DO write real files into the user\'s actual project here — right now, in this chat. There is no',
    '  separate "apply" step, no human copying code out of your reply: the host parses your File:/Edit:',
    '  blocks below and saves them to disk in the sandbox the instant your reply finishes. This is not a',
    '  hypothetical or a design document — it is the literal write mechanism. (There is no separate',
    '  interactive shell/tool-call API in this chat — this text format IS how you act, not a fallback',
    '  because you can\'t.)',
    ...
    '     ```',
    '',
    '  Worked example — a user asks to add a health-check endpoint, this is a complete, correct reply:',
    '',
    '     File: api/health.js',
    '     ```js',
