...
export const PROVIDERS = {
  ...
  // xAI, i.e. Grok. Not to be confused with `groq` above — different company,
  // different key, one letter apart. Its API is OpenAI-compatible, so it needs
  // no special handling beyond the endpoints.
  xai: {
    id: 'xai',
...
export const FALLBACK_MODELS = {
  ...
  xai: [
    // Live list comes from api.x.ai/v1/models; these are the offline fallback.
